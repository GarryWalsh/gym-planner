...
if plan is None:
    ...
    with hdr_r:
        ...
        badge = "🧠 AI Engine: Groq" if _src == "llm" else "🛠️ Engine: Local"
    ...
    with st.container():
        ...
        with pop_cols[1]:
            with st.popover("🧠 Summary"):
                ...
                _sum_badge = "🧠 Generated by AI (Groq)" if summary_llm else "📝 Generated locally"
...
# --- Debug footer ---
st.markdown("---")
with st.expander("AI Insight: last prompt & response", expanded=False):
